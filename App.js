...
const ProfileScreen = () => {
  const student = {
    name: "Tankiso Malapela",
    studentNumber: "901016811",
    profilePicture: require("./assets/x4.jpg"),
    currentSemester: "  4",
    semesterGrades: [
      { subject: "Business IT", grade: "B" },
      { subject: "Engineering Drawing", grade: "B" },
      { subject: "Fundamentals of Designx", grade: "C" },
    ],
  };
